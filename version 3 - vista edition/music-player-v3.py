...
# Load button images
start_img = pg.image.load(r'C:\Users\Huawei\PycharmProjects\Customized_Music_Player\version 3 - vista edition\play_button2.png').convert_alpha()
start_button = button.Button(10, 10, start_img, 0.2)
forward_img = pg.image.load(r'C:\Users\Huawei\PycharmProjects\Customized_Music_Player\version 3 - vista edition\forward.png').convert_alpha()
