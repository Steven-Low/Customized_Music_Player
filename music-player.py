...
songs_list=Listbox(root,selectmode=SINGLE,bg="black",fg="white",font=('arial',15),height=12,width=54,selectbackground="gray",selectforeground="black")
